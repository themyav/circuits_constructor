            ...
            if (element !== undefined) {
                ...
                switch (element) {
                    case "Источник переменного тока":
                        str += "<tr><td><input type=\"input\" class='show_U_and_R' unit='U' onchange='validate_values(this)'>" + "Постоянное напряжение" + "</td></tr>" +
                            ...
                            "<tr><td><input type=\"input\" class='show_U_and_R' uint='fi' onchange='validate_values(this)'>" + "Фаза" + "</td></tr>" +
                            "</table>" + "</div></td></tr>";
                        break;
                    case "Источник постоянного тока":
                        str += "<tr><td><input type=\"input\" class='show_U_and_R' unit='I' onchange='validate_values(this)'>" + "Ток" + "</td></tr>" +
                            "</table>" + "</div></td></tr>";
                        break;
                    case "Двигатель постоянного тока":
                        str += "<tr><td><input type=\"input\" class='show_U_and_R' unit='U' onchange='validate_values(this)'>" + "Номинальное напряжение" + "</td></tr>" +
                            "<tr><td><input type=\"input\" class='show_U_and_R' uint='V' onchange='validate_values(this)'>" + "Скорость холостого тока" + "</td></tr>" +
                            "<tr><td><input type=\"input\" class='show_U_and_R' unit='I' onchange='validate_values(this)'>" + "Пусковой ток" + "</td></tr>" +
                            "</table>" + "</div></td></tr>";
                        break;
